            ...
            <Dropdown
              ...
              overlay={(
                <div className="double-editor-overlay">
                  ...
                  <div className="double-editor-overlay-type"
                       style={{ marginBottom: 15, border: this.state.blockType === 'regular' && '1px solid #4284FF' }}
                       onClick={() => {
                         this.setState({
                           blockType: 'regular'
                         }, () => {
                  ...
                  <div className="double-editor-overlay-type"
                       style={{ marginBottom: 15, border: this.state.blockType === 'rule' && '1px solid #4284FF' }}
                       onClick={() => {
                         this.setState({
                           blockType: 'rule'
                         }, () => {
                  ...
                  >
                    <img style={{ marginBottom: -5, paddingRight: 5 }} src={Lamp} alt=""/>
                    <span>
                      Правило
                    </span>
                  </div>
